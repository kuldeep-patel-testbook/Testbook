...
import LibraryIllustration from "../..//Assets/Images/book-store-background.gif"
import './Home.css'
  ...
  return (
    <div className='home-component-container'>
      <div className='home-page-img-container'>
        <img className="home-page-background-img" src={LibraryIllustration} alt="Library store books"/>
      </div>

      <div className='book-home-category'>
        <h1 className='homepage-headings'>Category</h1>
      ...
      <div>
        <h1 className='homepage-headings'>New Books</h1>
        <NewArrivals/>
      </div>
      <Footer/>
