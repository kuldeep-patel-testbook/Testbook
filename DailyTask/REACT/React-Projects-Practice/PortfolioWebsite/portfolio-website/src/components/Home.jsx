    ...
    <>
      <section id='home' className='home'>
        <div className="intro">
          ...
          {/* <h4 className="description">I also develop payment functionalities...</h4> */}
      ...
      {showMore && (
        <div className="section active" id="section2" ref={sectionRef}>
          ...
          <div className="chatuser request">
            <div className="profile-pic">Client</div>
          ...
          <div className="chatuser response">
            <div className="bubble">
              <p>Now! Do you have a specific design style in mind (e.g., modern, minimalist, eco-friendly)?
                What pages do you want to include on the website?</p>
            </div>
          ...
          <div className="chatuser response">
            <div className="bubble">
              <p>Let me know if you need any further clarifications or have additional requirements!</p>
            </div>
